...
let graph_demo = [["Master Root Node (Click: hold shift and hit enter to set notes)",0,-1,0,"We can use latex like this:\n$$\\frac{2}{3}$$\n\nHIT ESCAPE TO EXIT AND SAVE\n",651,50,[1,2]],["After notes are set just hit enter without shift to view them",1,0,3,"We always hit escape to get back from here!",375,284,[]],["Embedding Web Resources: Click here twice",2,0,3,"Hit escape to go back!",907,182,[3,4]],["Images (Click Twice)",3,2,3,null,236,259,[5]],["Videos (Click Twice)",4,2,3,null,589,286,[6]],["Example (Hit Enter)",5,3,3,"<img src=\"https://avatars.githubusercontent.com/u/32969567?v=4\n\">",334,239,[7]],["Example (Hit Enter)",6,4,3,"\n<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/\n\nGj-Kr_nY9Gk\n\n\" frameborder=\"0\" allowfullscreen></iframe>",316,267,[8]],["Whoops you may have gone to far: click right mouse button to go back.",7,5,3,null,644,262,[]],["Click right mouse button to go back up",8,6,3,null,656,255,[]]]
...
class UserInterface
{
	...
	displaynote()
	{
		...
		document.getElementById("mathjaxdsp").hidden = false;

		if (this.currentdepthroot.atthisdepth[this.selectednodeidx].notetext == undefined || this.currentdepthroot.atthisdepth[this.selectednodeidx].notetext == "")
		{

			document.getElementById("mathjaxdsp").innerHTML = "No note set: hit escape to exit!";

		}
		else 
		{

			document.getElementById("mathjaxdsp").innerHTML = this.currentdepthroot.atthisdepth[this.selectednodeidx].notetext;
...
function prevent_back_delete(e)
{
...
function init()
{
	...
	window.onkeyup = prevent_back_delete;
